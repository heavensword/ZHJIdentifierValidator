...
#import "ZHJIdentifierValidator.h"
...
@implementation ZHJIdentifierValidator
...
+ (BOOL) isValidPhone:(NSString*)value
{
    ...
    if (![ZHJIdentifierValidator isValidNumber:value]) {
        return FALSE;
    }
...
+ (BOOL) isValidCreditNumber:(NSString*)value
{
    ...
    if (length >= 13) {
        result = [ZHJIdentifierValidator isValidNumber:value];
        if (result) {
...
+ (BOOL) isValidCardNumber:(NSString *)cardNumber {
    BOOL result = [ZHJIdentifierValidator isValidNumber:cardNumber];
    if (result) {
...
+ (BOOL) isValid:(IdentifierType) type value:(NSString*) value
{
    ...
    switch (type) {
        case IdentifierTypeZipCode:
            result = [ZHJIdentifierValidator isValidZipcode:value];
            break;
        case IdentifierTypeEmail:
            //            result = [MCCPIdentifierValidator isValidEmail:value];
            result = [ZHJIdentifierValidator validateEmail:value];
            break;
        case IdentifierTypePhone:
            result = [ZHJIdentifierValidator isValidPhone:value];
            break;
        case IdentifierTypeUnicomPhone:
            result = [ZHJIdentifierValidator isChinaUnicomPhoneNumber:value];
            break;
        ...
        case IdentifierTypeString:
            result = [ZHJIdentifierValidator isValidString:value];
            break;
        case IdentifierTypeIdentifier:
            result = [ZHJIdentifierValidator isValidIdentifier:value];
            break;
        case IdentifierTypePassort:
            result = [ZHJIdentifierValidator isValidPassport:value];
            break;
        case IdentifierTypeCreditNumber:
            result = [ZHJIdentifierValidator isValidCreditNumber:value];
            break;
        case IdentifierTypeBirthday:
            result = [ZHJIdentifierValidator isValidBirthday:value];
            break;
        case IdentifierTypeBankCardNumber:
            result = [ZHJIdentifierValidator isValidCardNumber:value];
        default:
            break;
    }
    return result;
